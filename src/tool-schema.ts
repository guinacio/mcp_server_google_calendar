...
export const tools = [
  ...
  },
  {
    ...
    description:
      'Check availability for yourself and/or others. When checking for other people in the organization, their emails will always be their name and then ' +
      EMAIL_DOMAIN,
    inputSchema: {
      type: 'object',
      properties: {
        ...
        items: {
          type: 'array',
          description:
            'List of calendars and/or groups to query for FreeBusy information. Optional.',
          items: {
            type: 'object',
            properties: {
              id: {
    ...
    inputSchema: {
      ...
      properties: {
        calendarId: {
          type: 'string',
          description:
            "The ID of the calendar to create the event in. Use 'primary' for the user's primary calendar.",
        },
        event: {
          type: 'object',
          ...
          properties: {
            ...
            colorId: {
              type: 'string',
              description:
                'The color of the event. Optional. See the Calendar UI for the list of available colors.',
            },
            start: {
              type: 'object',
              ...
              properties: {
                dateTime: {
                  type: 'string',
                  description:
                    "The start time of the event formatted as per RFC3339 (e.g., '2024-12-14T09:00:00-07:00')",
                },
                timeZone: {
                  type: 'string',
                  description:
                    "The time zone of the start time (e.g., 'America/Los_Angeles'). Defaults to calendar's time zone",
                },
              },
              required: ['dateTime'],
            },
              ...
              properties: {
                dateTime: {
                  type: 'string',
                  description:
                    "The end time of the event formatted as per RFC3339 (e.g., '2024-12-14T10:00:00-07:00')",
                },
                timeZone: {
                  type: 'string',
                  description:
                    "The time zone of the end time. Defaults to calendar's time zone",
                },
              },
              required: ['dateTime'],
            },
            recurrence: {
              ...
              items: {
                type: 'string',
                description:
                  "Recurrence rule in iCalendar format (e.g., 'RRULE:FREQ=WEEKLY;COUNT=10;BYDAY=TU')",
              },
            },
            attendees: {
              type: 'array',
            ...
            attachments: {
              type: 'array',
              description:
                'File attachments for the event (Google Drive files only)',
              items: {
                type: 'object',
                properties: {
                  fileId: {
            ...
            reminders: {
              ...
              properties: {
                useDefault: {
                  type: 'boolean',
                  description:
                    'Whether to use the default reminders of the calendar',
                  default: true,
                },
                overrides: {
                  type: 'array',
